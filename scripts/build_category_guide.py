...
def main() -> int:
    ...
    lines += [
        ...
        "  없었다는 뜻이다.",
        "",
        "⚠ 다만 **식품·화장품은 식약처 소관**이고 여행·음반 등은 물품이 아니다.",
        "  이 도구가 다루는 것은 전기용품·생활용품·어린이제품이므로 그 밖의",
        "  카테고리가 비어 있는 것은 **구멍이 아니라 선언된 경계**다 -",
        "  README 의 \"화장품·식품 등 식약처 소관 | 불가 | 별도 신고 체계\" 와",
        "  같은 말이다. 개별 카테고리가 어느 쪽인지는 대분류 이름을 보면 된다.",
        "",
        "```",
    ]
