...
BEFORE = {
    ...
    # ⚠ 2026-09-20 에 **정당하게 바뀐 값**이다 (P2). "잠시 후" 가 원인
    #   단정이라 뺐고, 본문(`verifier._lookup_failed`)과 같이 고쳤다.
    #   이 파일이 지키는 것은 "리팩터가 문구를 조용히 안 바꿨다" 이고,
    #   **정당하게 바꿀 때 여기를 같이 고치게 되는 것**이 설계다.
    "lookup_failed":
        "확인 미완료 — 정부 조회 서비스에 연결하지 못했습니다. "
        "근거 링크에서 번호를 직접 조회하실 수 있습니다.",
    "no_input":
...
def test_the_page_has_only_frame_text():
    ...
    frame = {
        "안심 소싱 돋보기", "본문으로 건너가기",
        # 바닥글 출처 줄. 여덟 화면 공통이라 틀이다 (2026-09-21 합치기).
        "데이터 · 국가기술표준원 · 제품안전정보센터 · 국가법령정보센터",
        "소개", "상품 검사", "대량 검사", "감시 목록", "다루는 범위",
        '왜 "모름" 이 나왔나',
